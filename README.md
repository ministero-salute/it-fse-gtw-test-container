...
|:---------------:|:----------------------------------------------------------------------------------------------------------------------:|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Versione *FHIR Transform* | [it-fse-gtw-container-fhir-transform](https://github.com/ministero-salute/it-fse-gtw-test-container/tree/main/it-fse-gtw-container-fhir-transform) | La seguente versione contiene il sottoinsieme minimo di microservizi necessari ad effettuare una conversione di un file CDA a un Bundle Json FHIR  |
